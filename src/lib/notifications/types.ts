...
export const NOTIFICATION_TYPE_LABELS: Record<NotificationTypeKey, string> = {
  ...
  company_created: "Societate creată",
  company_updated: "Profil societate actualizat",
  company_archived: "Societate arhivată",
  company_deleted: "Societate ștearsă",
  company_favorited: "Societate adăugată la favorite",
  company_engagement_up: "Interacțiuni societate în creștere",
