...
const candidateSteps = [
  {
    ...
    body: "Înregistrare gratuită instant. Adaugă experiența, educația și abilitățile pentru a fi remarcat de angajatori de top din toată țara.",
    color: STEEL,
  ...
  },
  {
    ...
    title: "Aplică direct",
    body: "Trimite candidatura cu un singur click rapid, iar ulterior urmărești pe dashboard toate aplicațiile tale la toate anunțurile.",
  ...
  },
  {
    ...
    body: "Salvează căutările tale specifice ca alerte și primești notificări automate când apar poziții noi care corespund criteriilor tale.",
...
const employerSteps = [
  ...
  },
  {
    ...
    body: "Adaugă posturi cu formulare de candidatură personalizate sau cu link extern.",
  },
  {
    number: "03",
    icon: <PeopleOutlineIcon sx={{ fontSize: 26 }} />,
    title: "Gestionează candidaturile",
    body: "Revizuiește simultan aplicațiile pe dashboard, contactează candidații și ia decizii mai rapide.",
  },
];
